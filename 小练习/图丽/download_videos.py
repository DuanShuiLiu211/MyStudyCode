...
def parse_output(output):
    ...
    format_matches = [[item.strip() for item in match] for match in format_matches]
    formats = []
...
def download_video(url, cookie, output_dir="./", remote_dir=None):
    ...
    output = subprocess.check_output(["powershell", "-Command", command]).decode(
        "utf-8"
    )
...
if __name__ == "__main__":
    ...
    for video_info in select_video_info_list:
        ...
        if match:
            ...
            output_dir = (
                "C:/Users/tuliwanghao/Desktop/WorkFile/Timestamp/20230801/datas"
            )
            remote_dir = (
                "tlkj@192.168.3.36:/home/tlkj/datas/wangh/rawdatas/internet_video/"
            )
