...
def conv_factory(x, concat_axis, nb_filter,
                 dropout_rate=None, weight_decay=5E-4):
...
def get_model_deep_speckle_adj(config):
    ...
    conv1 = Conv2D(64, 7, strides=2, activation='relu', kernel_initializer='he_normal')(conv1)
    conv1 = BatchNormalization(axis=3, gamma_regularizer=l2(1E-4), beta_regularizer=l2(1E-4))(conv1)
    ...
    conv10 = Conv2D(32, 3, activation='relu', padding='same', kernel_initializer='he_normal')(
